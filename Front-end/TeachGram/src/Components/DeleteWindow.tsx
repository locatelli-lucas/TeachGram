...
export function DeleteWindow() {
    const {setDeleteOpacity} = useContext(deleteContext);
    ...
    return (
        <DeletePopUpStyle className="delete-popup">
            ...
            <div className={"deletePopUpButtons"}>
                <ProfileConfigButton onClick={() => setDeleteOpacity(false)} text={"Cancelar"} backgroundColor={"none"} color={"#f37671"} border={"#f37671 1px solid"} />
